...
const laptops = {
  ...
  7: {
    ...
    brand: "Microsoft",
    description:
      "The Microsoft Surface Pro is a versatile 2-in-1 device that combines tablet portability with laptop performance. The brilliant 13-inch PixelSense touchscreen with 2880x1920 resolution offers exceptional clarity, while the detachable keyboard and slim pen support make it perfect for productivity and creativity. With all-day battery life and premium build quality, it's ideal for professionals who need flexibility without compromising performance.",
    price: "₱67,100",
    specs: {
